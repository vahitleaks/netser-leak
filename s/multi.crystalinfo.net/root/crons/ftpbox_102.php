...
$handle2= fopen("/usr/local/sigma/crystal/data/".date("m")."_".date("Y")."/102raw_".date("m")."_".date("Y").".dat","a+");
...
//        echo $buffer;
        if(strlen($buffer)>2){
           $sqlQuery =  "\n INSERT INTO RAW_DATA(DATA, DATE, SOURCE, SITE_ID,ERROR_CODE) VALUES ('".$buffer."',CURDATE(),'buffer',102, '0')";
   	   //echo $sqlQuery;
