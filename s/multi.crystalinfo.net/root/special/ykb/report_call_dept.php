...
<script language="JavaScript">
  function submit_form(sortby){
    document.all('sort_me').action= 'report_call_dept.php?act=src&type=<?=$type?>&order=' + sortby;    
    document.all('sort_me').submit();
   }
  function drill_down(d_id){
    document.all('sort_me').action= 'report_call_ext.php?act=src&type=<?=$type?>&DEPT_ID=' + d_id;    
    document.all('sort_me').submit();
   }
