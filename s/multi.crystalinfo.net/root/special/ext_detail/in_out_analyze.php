<?
  ...
  echo "<center>";
     page_header();
?>
<form name="outb_search" method="post" action="in_out_analyze_prn.php?act=src">
...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    <td nowrap width="50%">
    <?table_header("Giden-Gelen Çaðrý Analizi","100%");?>
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr> 
        <td width="45%" class="td1_koyu">Dahili(Girilmesi Gerek)</td>
