      ...
      <tr> 
        <td width="100%" class="td1_koyu" colspan="2">
              ...
              <td class="td1_koyu">Min. Ücret</td>
                      <td><input class="input1" size="10" type="text" name="PRICE" VALUE="<?if($PRICE==""){echo 1;}else{echo $PRICE;}?>" Maxlength="15"></td>
      ...
      <tr> 
       ...
       <table border=0 width="100%" cellspacing=0 cellpadding=0>
        ...
        <td  width="29%" class="td1_koyu">Çýktý Formatý</td>
           ...
           <tr id=div1> 
               <td width="45%" class="td1_koyu">Hatalý kayýtlarý al </td>
               <td width="55%"><input type="checkbox" name="geterrorrecs" VALUE="1" size="15" checked></td>
           </tr>
      </table>
    <?table_footer();?>
  </td>
