       ...
       <form name="extention_arama" method="post" onsubmit="return check_form(this);" action="extentions_src.php?act=src">
         ...
         <table cellpadding="0" cellspacing="0" border="0" width="60%">
            ...
            <tr> 
                ...
                <td width="50%"><input type="text" class="input1" name="SICIL_NO" VALUE="<?echo $SICIL_NO?>" size="10" Maxlength="10"></td>
            </tr>
            <tr>
...
<?
   ...
   if ($act == "src") {
         ...
         $kriter .= $cdb->field_query($kriter, "EXTENTIONS.SICIL_NO", "LIKE", "'%".$SICIL_NO."%'");
         ...
         $sql_str  = "SELECT EXTENTIONS.EXT_ID,EXTENTIONS.SICIL_NO,
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="header_beyaz">
        ...
        <td><a href="javascript:submit_form('extention_arama',1, 'EXTENTIONS.SICIL_NO')">Sicil No</a></td>
