          ...
          <td>
              ...
              <table class="formbg">
                   <tr class="form">
                    ...
                    <tr>
                    <td class="td1_koyu">Sicil No</td>
                    <td class="td1_koyu"><input type="text" class="input1" name="ACCOUNT_NO" VALUE="<?echo $row->ACCOUNT_NO?>" size="10" Maxlength="10">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" class="checkbox" name="FUIDU" VALUE="1" <?if ($row->FUIDU!="0"){echo checked;}?> >											
						Export sýrasýnda silinmesin
                    ...
                    <tr class="form">
                        ...
                        <td>
                         <select name="DEPT_ID" class="select1" id="selDeptId">
  ...
  <table align="right" width="100%" border="0">
    <tr>
      ...
      <td align="right"><a href="extentions.php?act=new"><img border="0" src="<?=IMAGE_ROOT?>yeni_kayit.gif" style="cursor:hand;"></a></td>
        ...
        <tr>
      <td align="center" colspan="6" width="100%"><a href="unrep_exts_src.php">Raporlanmak Ýstenmeyen Dahili Ekle</a></td>
    </tr>
  </table>
      <script language="javascript" src="/scripts/form_validate.js"></script>
      <script language="javascript">
            form_fields[0] = Array ("EXT_NO", "Dahili alanýný girmeniz gerekli.", TYP_NOT_NULL);
            form_fields[1] = Array ("DEPT_ID", "Departman alanýný seçmeniz gerekli.", TYP_DROPDOWN);
            form_fields[2] = Array ("SITE_ID", "Site alanýný girmeniz gerekli.", TYP_DROPDOWN);            
         <?if($act=='upd'){?>   
