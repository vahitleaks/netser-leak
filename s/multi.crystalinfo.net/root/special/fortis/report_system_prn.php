...
<?
  ...
  switch ($type){
       case 'ext':
      $sql_str = "SELECT EXTENTIONS.EXT_NO, EMAIL, ACCOUNT_NO, DEPTS.DEPT_NAME, EXTENTIONS.DESCRIPTION 
      ...
      $field2="ACCOUNT_NO";$field2_name="Sicil No";$width2="10%";$field2_ord="ACCOUNT_NO";
