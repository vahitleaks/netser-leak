<?
    ...
    page_header();
?>
<form name="inb_search" method="post" action="report_local_prn.php?act=src">
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <?table_header("Dahili Görüþme Raporu","100%");?>
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr> 
          <td width="45%" class="td1_koyu">Arayan Dahili</td>
          <td width="55%"><input class="input1" type="text" name="ORIG_DN" VALUE="<?echo $ORIG_DN?>" size="30"></td>
      </tr>
      <tr> 
        <td width="45%" class="td1_koyu">Arayan Departman</td>
        <td width="55%">
      ...
      <tr> 
        <td width="45%" class="td1_koyu">Aranan Dahili</td>
        <td width="55%"><input class="input1" type="text" name="TER_DN" VALUE="<?echo $TER_DN?>" size="15"></td>
      </tr>
      <tr> 
        <td width="45%" class="td1_koyu">Aranan Departman</td>
        <td width="55%">
          <select name="CALLED_DEPT_ID" class="select1" style="width:250;" multiple>
          <?  
            $strSQL = "SELECT DEPT_ID, DEPT_NAME FROM DEPTS $kriter ORDER BY DEPT_NAME";
            echo  $cUtility->FillComboValuesWSQL($conn, $strSQL, true,  $CALLED_DEPT_ID);
          ?>
          </select>
        </td>  
      </tr>
      <tr> 
        <td width="45%" class="td1_koyu">Min. Süre(Dk)</td>
        <td width="55%"><input class="input1" type="text" name="DURATION" VALUE="<?echo $DURATION?>" size="8"></td>
      </tr>
      <tr> 
        <td width="45%" class="td1_koyu">Csv Export</td>
        <td width="55%"><input class="input1" type="checkbox" name="CSV_EXPORT" VALUE="1" size="8"></td>
      </tr>         
        </table>
    <?table_footer();?>
  </td>
...
<script language="JavaScript" type="text/javascript">
  ...
  function Fillothercombos(my_val){
    FillSecondCombo('DEPT_ID',  'DEPT_NAME', '01SITE_ID='+ my_val  , ''   , 'CALLED_DEPT_ID' , '');
...
//Time functions ends here
  ...
  function submit_form(form_name){
        ...
        document.all('CALLED_DEPT_ID').name = 'CALLED_DEPT_ID[]';		
